...
<body class="antialiased text-slate-800">
    ...
    <div class="hero-bg relative overflow-hidden py-24 sm:py-32 flex items-center justify-center">
        <div class="relative z-10 text-center px-4 max-w-4xl mx-auto">
            ...
            <!-- Search Bar -->
            <form action="<?php echo e(route('katalog')); ?>" method="GET" class="max-w-xl mx-auto relative bg-white rounded-2xl shadow-2xl p-2 flex items-center">
                <i class="ph-bold ph-magnifying-glass text-slate-400 text-xl ml-4"></i>
                <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari nama barang, misal: Beras, Indomie..." class="w-full py-3 px-4 outline-none text-slate-700 font-medium bg-transparent">
...
<?php /**PATH C:\laragon\www\toko-kelontong\resources\views/katalog.blade.php ENDPATH**/ ?>