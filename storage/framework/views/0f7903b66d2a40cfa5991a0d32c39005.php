<?php $__env->startSection('header', 'Edit Kasir'); ?>
...
<div class="max-w-3xl mx-auto bg-white rounded-3xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100">
    ...
    <form action="<?php echo e(route('kasir.update', $kasir->id)); ?>" method="POST">
        <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="name" id="name" value="<?php echo e(old('name', $kasir->name)); ?>" required class="block w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 text-slate-800 rounded-xl focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition-colors placeholder-slate-400 shadow-inner font-medium">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="username" id="username" value="<?php echo e(old('username', $kasir->username)); ?>" required class="block w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 text-slate-800 rounded-xl focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition-colors placeholder-slate-400 shadow-inner font-medium">
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\toko-kelontong\resources\views/kasir/edit.blade.php ENDPATH**/ ?>