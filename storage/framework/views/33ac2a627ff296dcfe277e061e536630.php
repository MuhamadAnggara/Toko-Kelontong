...
<head>
    ...
    <style>
        ...
        .hero-bg {
            background-image: linear-gradient(rgba(17, 24, 39, 0.7), rgba(17, 24, 39, 0.8)), url('<?php echo e(asset("bg_login.jpg")); ?>');
...
<body class="antialiased text-slate-800">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-20 items-center">
                ...
                <div class="flex items-center space-x-8">
                    <a href="<?php echo e(route('katalog')); ?>" class="text-indigo-600 font-bold text-sm transition-colors hidden sm:flex items-center relative after:content-[''] after:absolute after:-bottom-7 after:left-0 after:w-full after:h-1 after:bg-indigo-600 after:rounded-t-lg">
                        <i class="ph-bold ph-book-open mr-2 text-lg"></i> Katalog
                    </a>
                    <a href="<?php echo e(route('tentang-kami')); ?>" class="text-slate-500 hover:text-indigo-600 font-semibold text-sm transition-colors hidden sm:flex items-center">
    ...
    <div class="hero-bg relative overflow-hidden py-24 sm:py-32 flex items-center justify-center">
        <div class="relative z-10 text-center px-4 max-w-4xl mx-auto">
            ...
            <!-- Search Bar -->
            <div class="max-w-xl mx-auto relative bg-white rounded-2xl shadow-2xl p-2 flex items-center">
                <i class="ph-bold ph-magnifying-glass text-slate-400 text-xl ml-4"></i>
                <input type="text" placeholder="Cari nama barang, misal: Beras, Indomie..." class="w-full py-3 px-4 outline-none text-slate-700 font-medium bg-transparent">
                <button class="px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-bold transition shadow-md">Cari</button>
            </div>
        </div>
    </div>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $barangs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="bg-white rounded-3xl border border-slate-100 overflow-hidden shadow-[0_4px_20px_rgb(0,0,0,0.03)] hover:shadow-[0_10px_40px_rgb(99,102,241,0.1)] hover:-translate-y-1 transition-all duration-300 group flex flex-col">
                    ...
                    <div class="aspect-[4/3] bg-slate-100 relative overflow-hidden flex-shrink-0">
                        <?php if($b->gambar): ?>
                            <img src="<?php echo e(asset('storage/' . $b->gambar)); ?>" alt="<?php echo e($b->nama_barang); ?>" class="w-full h-full object-cover group-hover:scale-105 transition duration-500">
                        <?php else: ?>
                        ...
                        <div class="absolute top-4 left-4">
                            <span class="bg-white/90 backdrop-blur-sm text-slate-800 text-xs font-bold px-3 py-1.5 rounded-full shadow-sm">
                                <?php echo e($b->kategori->nama_kategori ?? 'Umum'); ?>
                    ...
                    <div class="p-6 flex-1 flex flex-col">
                        <div class="text-xs font-mono text-slate-400 mb-2"><?php echo e($b->kode_barang); ?></div>
                        <h3 class="font-extrabold text-lg text-slate-800 mb-2 line-clamp-2 leading-tight"><?php echo e($b->nama_barang); ?></h3>
                        
                        <?php if($b->deskripsi): ?>
                            <p class="text-sm text-slate-500 mb-4 line-clamp-3 flex-1"><?php echo e($b->deskripsi); ?></p>
                        <?php else: ?>
                        ...
                        <div class="mt-4 pt-4 border-t border-slate-100 flex items-end justify-between mb-4">
                            <div>
                                ...
                                <p class="font-extrabold text-indigo-600 text-xl">Rp<?php echo e(number_format($b->harga_jual,0,',','.')); ?></p>
                            </div>
                            <div class="text-right">
                                <?php if($b->stok > 0): ?>
                                    <span class="bg-emerald-50 text-emerald-600 border border-emerald-200 text-xs font-bold px-2.5 py-1 rounded-lg flex items-center">
                                        <i class="ph-fill ph-check-circle mr-1"></i> Stok: <?php echo e($b->stok); ?>
                        ...
                        <!-- Tombol Beli -->
                        <?php if($b->stok > 0): ?>
                        <a href="https://wa.me/6282246258819?text=Halo%20Toko%20Kelontong,%20saya%20ingin%20membeli%20produk:%20<?php echo e(rawurlencode($b->nama_barang)); ?>%20(<?php echo e($b->kode_barang); ?>)" target="_blank" class="w-full mt-auto bg-slate-50 hover:bg-emerald-50 text-slate-700 hover:text-emerald-600 border border-slate-200 hover:border-emerald-300 transition-colors duration-300 rounded-xl py-2.5 font-bold text-sm flex items-center justify-center group/btn">
...
<?php /**PATH C:\xampp\htdocs\toko-kelontong\resources\views/katalog.blade.php ENDPATH**/ ?>