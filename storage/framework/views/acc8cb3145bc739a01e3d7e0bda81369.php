<?php $__env->startSection('header', 'Dashboard Utama'); ?>
    ...
    <div class="bg-white rounded-3xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 relative overflow-hidden group hover:-translate-y-1 hover:shadow-xl transition-all duration-300">
        ...
        <div class="flex items-start justify-between relative z-10">
            <div>
                ...
                <h3 class="text-4xl font-extrabold text-slate-800"><?php echo e($total_barang ?? 0); ?></h3>
    ...
    <div class="bg-white rounded-3xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 relative overflow-hidden group hover:-translate-y-1 hover:shadow-xl transition-all duration-300">
        ...
        <div class="flex items-start justify-between relative z-10">
            <div>
                ...
                <h3 class="text-4xl font-extrabold text-slate-800"><?php echo e($total_kategori ?? 0); ?></h3>
    ...
    <div class="bg-white rounded-3xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 relative overflow-hidden group hover:-translate-y-1 hover:shadow-xl transition-all duration-300">
        ...
        <div class="flex items-start justify-between relative z-10">
            <div>
                ...
                <h3 class="text-4xl font-extrabold text-slate-800"><?php echo e($total_kasir ?? 0); ?></h3>
                <p class="text-xs text-emerald-500 font-medium mt-2 flex items-center bg-emerald-50 px-2 py-1 rounded-lg w-fit">
...
<div class="bg-white rounded-3xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 mt-8">
    ...
    <div class="space-y-4">
        <?php $__empty_1 = true; $__currentLoopData = $aktivitas_terbaru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aktivitas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="flex items-center p-4 hover:bg-slate-50 rounded-2xl transition border border-transparent hover:border-slate-100 cursor-pointer">
            <div class="w-10 h-10 rounded-full flex items-center justify-center mr-4 
                <?php echo e($aktivitas->tipe == 'success' ? 'bg-emerald-100 text-emerald-600' : ''); ?>

                <?php echo e($aktivitas->tipe == 'info' ? 'bg-indigo-100 text-indigo-600' : ''); ?>

                <?php echo e($aktivitas->tipe == 'warning' ? 'bg-rose-100 text-rose-600' : ''); ?>">
                <?php if($aktivitas->tipe == 'success'): ?>
                    <i class="ph-bold ph-plus"></i>
                <?php elseif($aktivitas->tipe == 'info'): ?>
                    <i class="ph-bold ph-pencil-simple"></i>
                <?php elseif($aktivitas->tipe == 'warning'): ?>
            ...
            <div class="flex-1">
                <p class="font-bold text-slate-800"><?php echo e($aktivitas->judul); ?></p>
                <p class="text-xs text-slate-500 mt-0.5"><?php echo e($aktivitas->deskripsi); ?></p>
            </div>
            <span class="text-xs font-semibold text-slate-400 bg-slate-100 px-3 py-1 rounded-full whitespace-nowrap"><?php echo e($aktivitas->created_at->diffForHumans()); ?></span>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\toko-kelontong\resources\views/dashboard.blade.php ENDPATH**/ ?>