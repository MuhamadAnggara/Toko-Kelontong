<?php $__env->startSection('header', 'Data Kategori'); ?>
...
<div class="bg-white rounded-3xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100">
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 pb-4 border-b border-slate-100">
        ...
        <a href="<?php echo e(route('kategori.create')); ?>" class="mt-4 sm:mt-0 flex items-center px-5 py-2.5 bg-gradient-to-r from-emerald-500 to-teal-600 text-white rounded-xl shadow-lg shadow-emerald-200 hover:shadow-emerald-300 transform hover:-translate-y-0.5 transition-all text-sm font-bold">
        ...
        <table class="w-full text-left border-collapse">
            ...
            <tbody class="divide-y divide-slate-100 text-sm text-slate-700 font-medium">
                ...
                <tr class="hover:bg-emerald-50/30 transition-colors group">
                    <td class="py-4 px-6 text-slate-500 font-bold">#<?php echo e($k->id); ?></td>
                    <td class="py-4 px-6">
                        <div class="flex items-center">
                            <i class="ph-fill ph-tag text-emerald-500 text-xl mr-3 opacity-70 group-hover:opacity-100 transition"></i>
                            <span class="font-bold text-slate-800 text-base"><?php echo e($k->nama_kategori); ?></span>
                        </div>
                    </td>
                    <td class="py-4 px-6 text-right">
                         <div class="flex items-center justify-end space-x-2">
                            <a href="<?php echo e(route('kategori.edit', $k->id)); ?>" class="w-8 h-8 rounded-xl bg-slate-100 text-slate-500 hover:bg-emerald-100 hover:text-emerald-600 flex items-center justify-center transition-colors shadow-sm">
                                <i class="ph-bold ph-pencil-simple"></i>
                            </a>
                            <form action="<?php echo e(route('kategori.destroy', $k->id)); ?>" method="POST" class="inline-block" onsubmit="return confirm('Yakin ingin menghapus kategori ini?');">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\toko-kelontong\resources\views/kategori/index.blade.php ENDPATH**/ ?>