        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="nama_barang" id="nama_barang" value="{{ old('nama_barang', $barang->nama_barang) }}" required class="block w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 text-slate-800 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors placeholder-slate-400 shadow-inner font-medium">
                </div>
            </div>
            ...
            <div>
                ...
                @if($barang->gambar)
                    <div class="mb-3">
                        <img src="{{ asset('storage/' . $barang->gambar) }}" alt="Preview" class="w-32 h-32 object-cover rounded-xl border border-slate-200">
                    </div>
                @endif
                <div class="relative">
                    <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="stok" id="stok" value="{{ old('stok', $barang->stok) }}" required min="0" class="block w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 text-slate-800 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors placeholder-slate-400 shadow-inner font-bold">
                    </div>
                </div>
            </div>
