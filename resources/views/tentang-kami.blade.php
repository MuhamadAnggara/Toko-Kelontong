...
<head>
    ...
    <style>
        ...
        .hero-bg {
            background-image: linear-gradient(rgba(17, 24, 39, 0.8), rgba(17, 24, 39, 0.9)), url('{{ asset("bg_login.jpg") }}');
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-20 items-center">
                ...
                <div class="flex items-center space-x-8">
                    <a href="{{ route('katalog') }}" class="text-slate-500 hover:text-indigo-600 font-semibold text-sm transition-colors hidden sm:flex items-center">
                        <i class="ph-bold ph-book-open mr-2 text-lg"></i> Katalog
                    </a>
                    <a href="{{ route('tentang-kami') }}" class="text-indigo-600 font-bold text-sm transition-colors hidden sm:flex items-center relative after:content-[''] after:absolute after:-bottom-7 after:left-0 after:w-full after:h-1 after:bg-indigo-600 after:rounded-t-lg">
    ...
    <div class="hero-bg relative overflow-hidden py-24 sm:py-32 flex items-center justify-center">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 -mt-20 relative z-20 pb-20">
            ...
            <div class="text-center mt-12">
                ...
                <a href="{{ route('katalog') }}" class="px-8 py-4 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl shadow-xl shadow-indigo-200 hover:-translate-y-1 transition-all inline-flex items-center font-bold text-lg">
